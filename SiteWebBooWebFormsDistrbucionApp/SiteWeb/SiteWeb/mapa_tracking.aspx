<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mapa_tracking.aspx.cs" Inherits="SiteWeb.mapa_tracking" %>
...
<html  xmlns="http://www.w3.org/1999/xhtml">
  <head runat="server">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDAqwKC06eCZpcEasgP8DrRKU9kiUhR88s&callback=initMap"></script>
         <%-- <script type="text/javascript"
      src="http://maps.googleapis.com/maps/api/js?key=AIzaSyDAqwKC06eCZpcEasgP8DrRKU9kiUhR88s&sensor=TRUE">
    </script>--%>
    <script>

<%@ Page Language="C#" MasterPageFile="~/Views/principal.Master" Debug="true" AutoEventWireup="true" CodeBehind="ReporteTestNCD.aspx.cs" Inherits="SiteWeb.Reporte" %>
...
<!-- Example DataTables Card-->
    ...
    <form id="form3" runat="server">
        <asp:Button ID="btnbuscar3" runat="server" OnClick="btnbuscar3_Click" Text="Obtener NCD Test" />
    ...
    <LocalReport ReportPath="Content/Report/Report3.rdlc">
     </LocalReport>
